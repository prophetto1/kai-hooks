...
import { validateConfig as validateRuntimeConfig } from '../lib/config-model.mjs';
...
const configError = (errors) => {
  ...
  // UserPromptSubmit is fail-open; scripts/validate-runtime-hooks.mjs is the hard-fail validator.
  process.exit(0);
};
